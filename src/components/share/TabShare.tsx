...
const TabShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    "I found this useful emi calculator tool, check it out: https://seosaurus.in/tools/loan-payment-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/loan-payment-calculator/";
